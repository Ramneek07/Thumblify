        ...
        <>
            ...
            >
                ...
                <div className="hidden md:flex items-center gap-8 transition duration-500">
                    <Link className="hover:text-pink-300 transition" to="/">Home</Link>
                    <Link className="hover:text-pink-300 transition" to="/generate">Generate</Link>
                    {
                        isLoggedIn ? <Link className="hover:text-pink-300 transition" to="/my-generation">My Generations</Link>

                        : <Link className="hover:text-pink-300 transition" to="#">About</Link>
                    }
                    
                    <Link className="hover:text-pink-300 transition" to="/">Contact us</Link>
                </div>
